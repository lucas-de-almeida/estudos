...
import 'package:app_filmes/repository/movies/movies/movies_repository.dart';
import 'package:app_filmes/repository/movies/movies/movies_repository_impl.dart';
...
class AplicationBindigns implements Bindings {
  @override
  void dependencies() {
